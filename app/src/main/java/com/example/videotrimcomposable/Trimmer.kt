...
import com.example.videotrimcomposable.VideoTrimmer.Callback
import com.example.videotrimcomposable.VideoTrimmer.CutMode
import com.example.videotrimcomposable.VideoTrimmer.mapper.pxFromDp
...
class TimelineView : View {
    ...
    private fun initAttr(attrs: AttributeSet) {
        ...
        try {
            ...
            rightThumbPaint.color = Color.RED
            leftThumbPaint.strokeWidth = 40F
            rightThumbPaint.strokeWidth =40F
            frameDimentionRatio =40F
        } finally {
            ta.recycle()
        }
    }
